              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="col-span-1 sm:col-span-2 flex flex-col gap-2">
                  ...
                  <div className="border border-[#C4C6CF] rounded p-4 space-y-6.75">
                    {[
                      "සම්මන්ත්‍රණයක්",
                      "අභ්‍යාස වැඩපිළිවෙලක්",
                      "ශිල්පීය අභ්‍යාස පාඨමාලාවක්",
                      "සාකච්ඡාවක්",
                      "වෘත්තීය උපදේශක පාඨමාලාවක්",
                      "අධ්‍යයන චාරිකාවක්",
                      "පශ්චාත් උපාධි පාඨමාලාව",
                      "පුහුණු වැඩමුළුවක්",
                      "විදේශ නිලදූත කාර්‍යයක්",
                      "දිවයින තුල ඉටු කල නොහැකි ආයතන විෂය පථයට අදාල රාජකාරී කටයුත්තක්"
                    ].map((opt) => (
                      <label key={opt} className="flex items-center gap-3 cursor-pointer">
                        <input 
                          ...
                          value={opt} 
                          checked={applicationData.leave_nature === opt}
                          onChange={(e)=> setApplicationData({...applicationData, leave_nature:e.target.value})}
                        />
                ...
                <div className="col-span-1 sm:col-span-2 flex flex-col gap-2">
                  ...
                  <input
                    type="text"
                    value={applicationData.institution_designated_in_that_manner}
                    onChange={(e)=> setApplicationData({...applicationData, institution_designated_in_that_manner:e.target.value})}
                    className="w-full border border-[#C4C6CF] rounded bg-white px-3 py-3.5 text-base text-[#1A1B1E] outline-none focus:border-[#002046] focus:ring-1 focus:ring-[#002046] transition-colors"
                    />
                </div>
