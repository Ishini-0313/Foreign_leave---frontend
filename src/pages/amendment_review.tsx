...
import { ChevronsRight, FileStack, FileUser, TrendingUp } from "lucide-react";
...
export default function AmendmentReview() {
        ...
        <main className="flex-1 px-4 sm:px-6 py-6 space-y-8 overflow-y-auto">
          ...
          <div>
            ...
            <nav className="flex items-center gap-2 mb-3">
              ...
              <ChevronRight />
              <span className="text-[#002046] font-['Noto_Sans_Sinhala'] text-xs font-bold leading-4">{applicationData?.amendment.id}</span>
            </nav>
            ...
            <div className="flex items-center gap-3 mt-1">
                <div className="text-gray text-sm bg-blue-200 px-3 rounded-xl">
                  {applicationData?.amendment.status}
                </div>
                <div className="text-gray-500">
                  Submitted on: {new Date(applicationData?.amendment.created_at).toLocaleDateString()} : {new Date(applicationData?.amendment.created_at).toLocaleTimeString()}
                </div>
            </div>
          ...
          <div className="flex flex-col gap-8  p-8">
            ...
            <div className="flex justify-between bg-white p-8 rounded-lg shadow-sm hover:scale-102 text-[#002046]"
              onClick={()=>navigate(`/amendment/${id}/form`)}>
            ...
            <div className="flex justify-between bg-white p-8 rounded-lg shadow-sm hover:scale-102 text-[#002046]" onClick={()=>navigate(`/amendment/${id}/documents`)}>
                <div className="flex gap-2 items-center">
                    <FileStack/>
            ...
            <div className="flex justify-between bg-white p-8 rounded-lg shadow-sm hover:scale-102 text-[#002046]" onClick={()=>navigate(`/amendment/${id}/tracking`)}>
                <div className="flex gap-2 items-center">
                    <TrendingUp/>
